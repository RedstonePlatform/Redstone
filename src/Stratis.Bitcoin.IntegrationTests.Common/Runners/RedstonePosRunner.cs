...
namespace Stratis.Bitcoin.IntegrationTests.Common.Runners
{
    public sealed class RedstonePosRunner : NodeRunner
    {
        ...
        {
            var settings = new NodeSettings(this.Network, ProtocolVersion.PROVEN_HEADER_VERSION, this.Agent, args: new string[] { "-conf=redstone.conf", "-datadir=" + this.DataFolder });
