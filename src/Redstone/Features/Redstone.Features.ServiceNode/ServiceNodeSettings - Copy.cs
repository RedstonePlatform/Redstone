...
//{
//    // TODO: SC - lots of stuff duplicated from NodeSettings - consolidate
...
//        public ServiceNodeSettings(Network network = null, ServiceNodeProtocolVersion protocolVersion = ServiceNodeProtocolVersion.TESTNET_INITIAL,
//            string agent = "RedstoneServiceNode", string[] args = null, NetworksSelector networksSelector = null)
//        {
...
//                this.DataDir = this.CreateDefaultDataDirectories(Path.Combine("RedstoneServiceNode", this.Network.RootFolderName), this.Network);
//            }
//            else
//            {
...
//        public static ServiceNodeSettings Default(Network network, ServiceNodeProtocolVersion protocolVersion = SupportedProtocolVersion)
//        {
//            return new ServiceNodeSettings(network, protocolVersion);
//        }
...
//            ServiceNodeSettings defaults = Default(network: network);
