...
namespace Redstone.Core.Policies
{
    /// <summary>
    /// Redstone-specific standard transaction definitions.
    /// </summary>
    public class RedstoneStandardScriptsRegistry : StandardScriptsRegistry
    {
