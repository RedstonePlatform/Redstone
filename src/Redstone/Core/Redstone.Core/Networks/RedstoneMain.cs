...
namespace Redstone.Core.Networks
{
    ...
    public class RedstoneMain : Network
    {
        ...
        public RedstoneMain()
        {
            ...
            {
               new NetworkAddress(IPAddress.Parse("80.211.88.201"), 19056), // cryptohunter node #8
               new NetworkAddress(IPAddress.Parse("80.211.88.233"), 19056), // cryptohunter node #9
               new NetworkAddress(IPAddress.Parse("80.211.88.244"), 19056), // cryptohunter node #10
               new NetworkAddress(IPAddress.Parse("35.178.169.232"), 19056), // cryptohunter AWS node
               new NetworkAddress(IPAddress.Parse("80.211.84.170"), 19056), // cryptohunter node #4
            };
