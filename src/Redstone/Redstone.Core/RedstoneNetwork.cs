    ...
    public class RedstoneNetwork
    {
        ...
        private static Network InitRedstoneTest()
        {
            ...
            var builder = new NetworkBuilder()
                ...
                .AddDNSSeeds(new[]
                {
                    new DNSSeedData("35.178.85.161", "35.178.85.161") // initial test node will need to be updated
            ...
            {
                new NetworkAddress(IPAddress.Parse("35.178.85.161"), builder.Port), // initial test node will need to be updated
