namespace Redstone.Core.Tests
{
    ...
    public class NetworkTests
    {
        ...
        public void RedstoneMainIsInitializedCorrectly()
        {
            ...
            Assert.Null(network.Consensus.BIP9Deployments[BitcoinBIP9Deployments.TestDummy]);
            Assert.Null(network.Consensus.BIP9Deployments[BitcoinBIP9Deployments.CSV]);
            Assert.Null(network.Consensus.BIP9Deployments[BitcoinBIP9Deployments.Segwit]);
        ...
        public void RedstoneTestnetIsInitializedCorrectly()
        {
            ...
            Block genesis = network.GetGenesis();
            Assert.Equal(uint256.Parse("0x6076e1f485f447ee49cc8d808cb3c71480d1451f3dc749325aa4ff20eb7b5538"),
                genesis.GetHash());
