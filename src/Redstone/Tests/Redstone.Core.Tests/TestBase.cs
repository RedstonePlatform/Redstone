...
namespace Redstone.Core.Tests
{
    public class TestBase
    {
        ...
        public static DataFolder CreateDataFolder(object caller, [System.Runtime.CompilerServices.CallerMemberName] string callingMethod = "")
        {
            ...
            var dataFolder = new DataFolder(new NodeSettings(networksSelector: RedstoneNetworks.NetworksSelector, args: new string[] { $"-datadir={AssureEmptyDir(directoryPath)}" }).DataDir);
            return dataFolder;
        }
