...
using NLog;
using Redstone.IntegrationTests.Common.Runners;
...
namespace Redstone.IntegrationTests.Common.EnvironmentMockUpHelpers
{
    public class NodeBuilder : IDisposable
    {
        ...
        public CoreNode CreateRedstonePowNode(Network network)
        {
            return CreateNode(new RedstonePowRunner(this.GetNextDataFolderName(), network));
        }

        public CoreNode CreateRedstoneCustomPowNode(Network network, NodeConfigParameters configParameters)
        {
        ...
        public CoreNode CreateRedstonePosNode(Network network)
        {
            return CreateNode(new RedstonePosRunner(this.GetNextDataFolderName(), network), "stratis.conf");
        }
