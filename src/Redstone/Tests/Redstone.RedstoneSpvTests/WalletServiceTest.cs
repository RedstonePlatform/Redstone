...
namespace Redstone.RedstoneSpvTests
{
    public class WalletServiceTest : LogsTestBase
    {
        ...
        public void GetGeneralInfoSuccessfullyReturnsWalletGeneralInfoModel()
        {
            ...
            var controller = new WalletService(this.LoggerFactory.Object, mockWalletWrapper.Object, new Mock<IWalletTransactionHandler>().Object, new Mock<IWalletSyncManager>().Object, connectionManagerMock.Object, Network.Main, concurrentChain, new Mock<IBroadcasterManager>().Object, DateTimeProvider.Default);
        ...
        public void GetHistoryWithDuplicateSpentTransactionsSelectsDistinctsSpentTransactionsForDuplicates()
        {
            ...
            var controller = new WalletService(this.LoggerFactory.Object, mockWalletManager.Object, new Mock<IWalletTransactionHandler>().Object, new Mock<IWalletSyncManager>().Object, It.IsAny<ConnectionManager>(), Network.Main, new Mock<ConcurrentChain>().Object, new Mock<IBroadcasterManager>().Object, DateTimeProvider.Default);
            var model = controller.GetHistory(new WalletHistoryRequest
            {
                WalletName = walletName
            });
        ...
        public void SendTransactionSuccessfulReturnsWalletSendTransactionModelResponse()
        {
            ...
            var controller = new WalletService(this.LoggerFactory.Object, new Mock<IWalletManager>().Object, new Mock<IWalletTransactionHandler>().Object,
        ...
        public void SendTransactionFailedBecauseNoNodesConnected()
        {
            ...
            WalletService controller = new WalletService(this.LoggerFactory.Object, new Mock<IWalletManager>().Object, new Mock<IWalletTransactionHandler>().Object,
                new Mock<IWalletSyncManager>().Object, connectionManagerMock.Object, Network.Main, new Mock<ConcurrentChain>().Object, mockWalletWrapper.Object, DateTimeProvider.Default);
        ...
        public void GetTransactionFeeEstimateWithValidRequestReturnsFee()
        {
            ...
            WalletService controller = new WalletService(this.LoggerFactory.Object, mockWalletWrapper.Object, mockWalletTransactionHandler.Object, new Mock<IWalletSyncManager>().Object, It.IsAny<ConnectionManager>(), Network.Main, new Mock<ConcurrentChain>().Object, new Mock<IBroadcasterManager>().Object, DateTimeProvider.Default);
        ...
        public void RemoveAllTransactionsWithSyncEnabledSyncsAfterRemoval()
        {
            ...
            var controller = new WalletService(this.LoggerFactory.Object, walletManager.Object, new Mock<IWalletTransactionHandler>().Object, walletSyncManager.Object, It.IsAny<ConnectionManager>(), Network.Main, chain, new Mock<IBroadcasterManager>().Object, DateTimeProvider.Default);
