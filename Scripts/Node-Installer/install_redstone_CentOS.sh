...
declare -r COINRUNCMD="sudo dotnet ./Redstone.RedstoneFullNodeD.dll -testnet -datadir=/home/${NODE_USER}/.redstonenode -iprangefiltering=0" ## additional commands can be used here e.g. -testnet or -stake=1
