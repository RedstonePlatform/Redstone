...
$publish_directory="..\..\src\Redstone\Programs\Redstone.RedstoneFullNodeD\bin\${configuration}\netcoreapp2.1\$runtime\publish"
...
& $warp --arch windows-x64 --input_dir $publish_directory --exec Redstone.RedstoneFullNodeD.exe --output $publish_directory\Redstone-$runtime-$git_commit.exe
